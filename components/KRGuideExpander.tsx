        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm text-gray-400">
              클릭하여 열고 닫기 • 스튜디오 사용법과 데이터 불러오기 안내
            </p>
          </div>
        </div>
        <svg
      ...
      {open && (
        <div className="px-4 md:px-6 pb-4 md:pb-6 pt-0 text-sm leading-6 text-gray-300 space-y-4 border-t border-gray-800">
          <div className="space-y-2">
            ...
            <p>
              이 스튜디오는 팩터 아이디어를 수식으로 표현하고 간단한 시뮬레이션을 통해 성과를 빠르게
              검증하도록 돕습니다. 좌측 패널에서 설정을 바꾸고, 수식 에디터에서 알파를 정의한 뒤
              결과 영역에서 KPI와 PnL을 확인하세요.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p>
              야후 파이낸스 API를 통해 과거 일봉(최대 5년)을 불러올 수 있습니다. 브라우저에서 CORS
              제한이 있을 수 있어 처음 사용할 때{' '}
              <a
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-300">
              <li>
                <span className="text-gray-200 font-medium">설정</span>: 유니버스, 제약, 목표 등을
                구성합니다.
              </li>
              <li>
                <span className="text-gray-200 font-medium">알파 정의</span>: 수식을 직접 입력하거나
                AI로 생성합니다.
              </li>
              <li>
                <span className="text-gray-2 00 font-medium">실행</span>: 시뮬레이션을 실행하고
                KPI/차트를 확인합니다.
              </li>
              <li>
                <span className="text-gray-200 font-medium">개선</span>: 성능/안정성을 기준으로
                수식을 반복 개선합니다.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-400">
              아래 예시는 에디터의 AI 프롬프트, 또는 MCP 도구 호출(지원 환경)로 활용할 수 있습니다.
            </p>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                >
                  모멘텀 기본: rank(close / delay(close, 20)) - rank(volume)
                </button>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  단기 과매수 회피: rank(returns, 20) - Ts_rank(volume, 5)
                </button>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  밸류+퀄리티 혼합: z(revenue)+z(ebitda)+z(1/price)
                </button>
                <button
                  type="button"
                  onClick={() => {
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  설명용 예시: Ts_rank(close/delay(close,1),10) - Ts_rank(volume,10)
                </button>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <button
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  모멘텀×변동성: rank(close/delay(close,60)) / (1+stddev(returns,20))
                </button>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  밸류-볼 감쇠: rank(1/price)+z(revenue)-z(stddev(returns,60))
                </button>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  수급·리스크 혼합: corr(returns,volume,20)-Ts_rank(stddev(returns,20),60)
                </button>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <button
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  IC 예측용 피처 예시: rank(returns,60) - rank(stddev(returns,20))
                </button>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-cyan-300 text-left border border-gray-700"
                >
                  소프트맥스 가중 컨셉: softmax(rank(returns,20), tau=0.5)/vol
                </button>
              </div>
            </div>
            ...
            <div className="rounded-md bg-gray-900/70 border border-gray-800 p-3 text-xs text-gray-400">
              <p className="mb-1">
                MCP 사용 환경이라면 다음과 같이 직접 도구를 호출할 수도 있습니다:
              </p>
